...
interface PathData {
  id: string;
  image: string; // <-- এখানে তোমার ছবির path/URL বসাও
  label: string;
  title: string;
  featuresLeft: string[];
...
// ---- Data --------------------------------------------------------------
// শুধু `image` ফিল্ডে তোমার নিজের ছবির path/URL বসিয়ে দিলেই কাজ হয়ে যাবে।
// accent: "orange" | "blue" — কার্ডের glow border আর বাটনের কালার কন্ট্রোল করে।

const paths: PathData[] = [
  {
    id: "future-you-want",
    image: "/images/path-1.png", // <-- এখানে তোমার ছবি (bright city) বসাও
  ...
  {
    id: "future-to-avoid",
    image: "/images/path-2.png", // <-- এখানে তোমার ছবি (dark dystopian city) বসাও
...
const accentStyles: Record<
  Accent,
  { text: string; border: string; glow: string; check: string }
> = {
  orange: {
  ...
  return (
    <div className="min-h-screen w-full py-16 max-sm:px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
      ...
      <div className="text-center mb-14">
        {/* <p className="text-[13px] tracking-[0.25em] text-orange-300/80 font-medium mb-5">
          THE CHOICE IS STILL YOURS
        </p> */}
        <SmallTitle
          children="THE CHOICE IS STILL YOURS"
          classNameText=""
          fontSize="16px"
        />
...
function PathCard({ path }: { path: PathData }) {
  ...
  return (
    <div
      className="rounded-2xl overflow-hidden border bg-black flex flex-col"
    ...
    >
      ...
      <div className="px-6 pt-4 pb-6 flex-1 flex flex-col">
        ...
        <h3 className="text-white text-2xl font-mono font-medium mb-4">
          {path.title}
        </h3>
        ...
        <button
          type="button"
          className={`mt-auto w-full rounded-lg border ${accent.border} bg-black/60 text-white text-sm tracking-wide font-medium py-3 flex items-center justify-center gap-2 transition-transform hover:scale-[1.02]`}
